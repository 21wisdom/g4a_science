...
export const CHAPTER_CONTENT = {
  ...
  lines: [
    ...
    briefing: {
      ...
      },
      {
        ...
        body: '갯벌 흙은 물에 잠겨 있어 산소가 부족해요. 산소가 적으면 죽은 생물과 식물이 잘 썩지 않아서 탄소가 흙 속에 갇힌 채 오래 쌓입니다. 특히 고운 펄이 많고 염생식물이 자라는 갯벌 위쪽일수록 유기물을 더 잘 붙잡아 둡니다.',
        highlight: '고운 펄이 쌓이는 곳일수록 탄소가 더 많이 저장돼요.',
      },
      {
        emoji: '🥤',
        title: '미세플라스틱이란?',
  ...
  ch4_energy: {
    story: {
  lines: [
    '지난 여름, 훈이는 바닷가에서 커다란 하얀 바람개비를 처음 봤어. "저게 뭐예요?"',
